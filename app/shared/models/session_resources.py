...
class SessionResource(Base):
    ...
    resource_id = Column(UUID(as_uuid=True), ForeignKey("resource_files.id", ondelete="CASCADE"), primary_key=True, nullable=False)
    label = Column(String, nullable=True)

    resource = relationship("ResourceFile", lazy="joined")